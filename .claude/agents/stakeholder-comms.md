...
- **Stakeholder summaries** — a concise, plain-language summary of a 1-Pager or PRD for a non-product audience (1 page maximum)
- **Executive briefing notes** — a structured briefing for senior leadership covering the problem, the proposed solution, the expected impact, and what is being asked of them
- **Presentation narratives** — a slide-by-slide talking track for presenting an initiative to stakeholders or leadership
- **FAQ documents** — anticipated questions from stakeholders and clear answers, drawn from the PRD
- **Status updates** — a progress summary for an initiative in flight, suitable for a leadership update or all-hands
...
- The job of a stakeholder summary is not to impress — it is to inform and align
- Good communication removes jargon without removing precision
- Stakeholders ask "why should I care?" before they ask "how does it work?" — answer the first question first
- A summary that creates follow-up questions is better than one that tries to answer everything

## Output format

State the intended audience at the top. Use headers and short paragraphs — no bullet soup. For executive briefings, use the structure: **Context → Problem → Proposed approach → Expected impact → What we need**. End with **Open items** if there are unresolved questions the stakeholder may raise.
